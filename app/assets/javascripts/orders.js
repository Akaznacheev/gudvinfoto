...
function updateData() {
    ...
    //to refactoring
    $('#data').css('width',Math.round(book_width)+'px');
    $('#data').css('height',Math.round(book_height)+'px');
    $('.order_about_book_cover').css('margin','0 auto '+Math.round(5*0.00545*background.height)+'px')
    $('.text_photobook').css('font-size',Math.round(3*0.00545*background.height)+'px');
    $('.text_photobook').css('margin-bottom',Math.round(4*0.00545*background.height)+'px')
    $('.order_about_book_about').css('font-size',standart_font_size+'px');
    $('h1').css('font-size',Math.round(6*0.00545*background.height)+'px');
    $('.order_form_box input, textarea').css('font-size',standart_font_size+'px');
    $('.order_form_box input, textarea').css('margin',Math.round(0.5*0.00545*background.height)+'px 0');
    $('.order_form_box input, textarea').css('padding',Math.round(0.5*0.00545*background.height)+'px '+Math.round(0.00545*background.height)+'px');
    ...
    $('.pay p').css('font-size',standart_font_size+'px');
    $('.pay a').css('font-size',standart_font_size+'px');
    $('.pay p').css('margin-bottom',Math.round(3*0.00545*background.height)+'px');
